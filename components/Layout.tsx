  ...
  return (
    <>
      <div className="flex justify-center bg-gray-300">
        <div className="bg-[#F6FAFD] text-[#1F1D28] dark:bg-[#1E1E20] dark:text-[#FFFFFF] border-2 border-blue-500 h-[100vh] w-[640px] flex flex-col justify-between">
          <header className=" h-[100px]  flex justify-center items-center relative border-b-2 shadow-md">
            <h1 className="text-4xl font-bold font-serif">{props.title}</h1>
            {/* 웹제목{props.title} */}
            {/* 다크모드버튼!!!!! */}
            <div
              onClick={다크모드전환}
              className="absolute right-10 cursor-pointer hover:bg-slate-300 rounded-2xl p-1 "
            >
              <svg
              ...
              <Link href={"/"}>
                <button
                  className={cls(
                    ...
                    router.pathname === "/"
                      ? " font-extrabold text-[#345780] dark:text-[#b3e3ff]"
                      : ""
                  )}
                >
